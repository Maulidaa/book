							...
							<div class="card-body">
								...
								<form action="{{ route('user.store') }}" method="POST">
									...
									<div class="form-group">
										...
										<input type="text" name="name" class="form-control" placeholder="Enter user name" required value="{{ old('name') }}">
									</div>
									<div class="form-group">
									...
									<button type="submit" class="btn bg-indigo-300 btn-block">Create User</button>
								</form>
							</div>
						</div>
					</div>
